  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::morai_msgs::ObjectStatusListExtended_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.npc_list.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::morai_msgs::ObjectStatusExtended_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.npc_list[i]);
    }
    if (v.npc_list.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.pedestrian_list.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::morai_msgs::ObjectStatusExtended_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.pedestrian_list[i]);
    }
    if (v.pedestrian_list.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.obstacle_list.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::morai_msgs::ObjectStatusExtended_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.obstacle_list[i]);
    }
    if (v.obstacle_list.empty() || false)
      s << "]";
  }
